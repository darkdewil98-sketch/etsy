...
- `research/<date>/` holds dated research runs (Trends, Printful costs, USPTO screens).
  ...
  score_opportunities.py -> build_report.py. Round 3 data received and applied (data/round3_*.txt, data/pillow_16in_prices.csv; run scripts/pillow_16in.py before scoring).
