...
C = [
 ("engagement ornament", ["personalized engagement ornament", "first christmas engaged ornament", "engaged ornament", "engaged christmas ornament"],
  ...
  "Finalist screen 2026-09-26: no live exact mark in IC 016/020/021/024/025/028 for 'engaged', 'engaged 2026', 'our first christmas engaged', 'first christmas engaged', 'the year we got engaged', 'future mr and mrs', 'she said yes'. Avoid 'JUST MARRIED' on apparel (Reg. 2932679, IC 025 swimwear/intimates).",
 ...
 ("first christmas married ornament", ["newlywed ornament", "mr and mrs ornament", "personalized wedding ornament", "married ornament"],
  ...
  "Finalist screen 2026-09-26: no live exact mark in product classes for 'first christmas married', 'our first christmas married', 'first christmas as mr and mrs', 'our first christmas', 'newlyweds', 'mr and mrs'/'mr & mrs' (20 live marks contain 'Mr & Mrs' — avoid as standalone text).",
  "NOT VERIFIED.",
 ...
 ("dog christmas stocking", ["cat christmas stocking", "pet stocking"],
  ...
  "Avoid 'PAWSOME' (Reg. IC 009/016/028/041; pending IC 021), 'FURBABY' (Reg. IC 021, pet cages), 'MERRY & BRIGHT' (Reg. IC 020 pet beds / 024 throws / 028 pet toys), 'MY DOG', 'GOOD DOG'.",
  "NOT VERIFIED.",
 ...
 ("custom dog pillow", ["custom cat pillow", "custom pet pillow"],
  ...
  "Dog and cat pillow terms carry a Very high conversion label with 9.5k–17.3k listings; the broader 'custom pet pillow' (3.2k/18.2k VH) confirms demand but contains the registered phrase 'PET PILLOW'.",
 ...
 ("new house ornament", ["new home ornament", "first christmas in new home ornament", "first house ornament", "our first home ornament"],
  ...
  "Avoid 'HOME SWEET HOME' (Reg. 7006924 / pending 99061613, IC 021) and 'WELCOME HOME' (pending IC 024/020/025; Reg. IC 016). No live mark found for 'our first home', 'our new home', 'new home 2026', 'first christmas in our new home', 'keys to our first home' (finalist screen 2026-09-26).",
 ...
 ("dog memorial gift", ["pet memorial gift", "pet remembrance gift", "dog remembrance gift"],
  ...
  "Avoid 'RAINBOW BRIDGE' (Reg. 2725281, IC 020: pet memorial plaques/markers/urns; Reg. 8198078 IC 028 covers toy bikes), 'FOREVER IN MY HEART' (Reg. 7359901, IC 020 pillows), 'ALWAYS IN MY HEART' (IC 014 jewelry; IC 016 pending).",
  "NOT VERIFIED.",
 ...
 ("custom dog shirt", ["custom pet sweatshirt", "custom dog hoodie", "dog mom gift"],
  ...
  "Avoid 'PAWSOME', 'FURBABY', 'MY DOG' (Reg. IC 025), 'GOOD BOY' (pending IC 025). 'Dog mom': no exact live mark in product classes but 8 live marks contain it — avoid 'DOG MOM' as the main design text.",
  "NOT VERIFIED.",
...
PRICE_KW = {  # opportunity -> snapshot keywords used as evidence (first one drives the margin score)
    ...
    "custom dog pillow": ["custom dog pillow", "custom pet pillow"],
