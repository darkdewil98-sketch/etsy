...
S = {  # product family -> [(supplier label, product cost, US shipping first item)]
 "ornament": [("Printful ceramic 2-side #900", 7.73, 5.89),
              ("Printify / SwiftPOD ceramic (bp 1632, from)", 4.93, 4.79),
              ("Printify / SwiftPOD ceramic, Premium (from)", 3.88, 4.79),
 ...
 "mug15": [("Printful 15oz #19", 8.11, 7.29), ("Printful 11oz #19", 6.07, 6.69),
           ("Printify / Taylor 11oz (bp 1244, from)", 5.86, 7.29), ("Printify / Taylor 11oz, Premium", 4.38, 7.29),
